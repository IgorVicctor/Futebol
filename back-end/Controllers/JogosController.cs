...
namespace Futebol.Controllers
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        public JogosController(FutebolContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Jogo>> PostJogo(Jogo jogo)
        {
            ...
            return CreatedAtAction("GetJogo", new { id = jogo.arbitragemId }, jogo);
        }
        ...
        {
            return _context.Jogo.Any(e => e.arbitragemId == id);
        }
    }
}
