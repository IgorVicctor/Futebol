...
namespace Futebol.Controllers
{
    ...
    public class JogadoresController : ControllerBase
    {
        ...
        public JogadoresController(FutebolContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Jogador>> PostJogador(Jogador jogador)
        {
            ...
            return CreatedAtAction("GetJogador", new { id = jogador.timeId }, jogador);
        }
        ...
        {
            return _context.Jogadores.Any(e => e.timeId == id);
        }
    }
}
