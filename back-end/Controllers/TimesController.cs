...
namespace Futebol.Controllers
{
    ...
    public class TimesController : ControllerBase
    {
        ...
        public TimesController(FutebolContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Time>> PostTime(Time time)
        {
            ...
            return CreatedAtAction("GetTime", new { id = time.competicaoId }, time);
        }
        ...
        {
            return _context.Time.Any(e => e.competicaoId == id);
        }
    }
}
